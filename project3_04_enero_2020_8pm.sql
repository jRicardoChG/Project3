...
--
-- Name: orders_carritocompras; Type: TABLE; Schema: public; Owner: ricardo
--

CREATE TABLE public.orders_carritocompras (
    id_prod_car integer NOT NULL,
    subtipo_prod_car character varying(200) NOT NULL,
    tamano_prod_car character varying(100) NOT NULL,
    precio_prod_car integer NOT NULL,
    toppings_prod_car character varying(200),
    id_dueno_id integer NOT NULL,
    fecha_prod_car timestamp with time zone NOT NULL
);


ALTER TABLE public.orders_carritocompras OWNER TO ricardo;

--
-- Name: orders_carritocompras_id_prod_car_seq; Type: SEQUENCE; Schema: public; Owner: ricardo
--

CREATE SEQUENCE public.orders_carritocompras_id_prod_car_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.orders_carritocompras_id_prod_car_seq OWNER TO ricardo;

--
-- Name: orders_carritocompras_id_prod_car_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ricardo
--

ALTER SEQUENCE public.orders_carritocompras_id_prod_car_seq OWNED BY public.orders_carritocompras.id_prod_car;
...
CREATE TABLE public.orders_prod_orden (
    ...
    toppings character varying(200)
);
...
--
-- Name: orders_carritocompras id_prod_car; Type: DEFAULT; Schema: public; Owner: ricardo
--

ALTER TABLE ONLY public.orders_carritocompras ALTER COLUMN id_prod_car SET DEFAULT nextval('public.orders_carritocompras_id_prod_car_seq'::regclass);
...
57	Can add carrito compras	15	add_carritocompras
58	Can change carrito compras	15	change_carritocompras
59	Can delete carrito compras	15	delete_carritocompras
60	Can view carrito compras	15	view_carritocompras
\.
...
1	pbkdf2_sha256$150000$SWxH037IsSb8$h+e9Bo/k7lY+yguroffgABGenZRPDDi6eutR5DZ3as0=	2020-01-04 18:43:07.016452-05	t	ricardo			richago29@gmail.com	t	t	2019-11-17 15:33:06.132318-05
2	pbkdf2_sha256$150000$scKaCbrPZUR8$fyOn4wcp6P/eqAaITe3EgteW6m1cnLgtqZMdjCGKg3Y=	2020-01-04 20:09:06.778516-05	f	hermes	hermes	hernandez	hermes@gmail.com	f	t	2020-01-03 09:28:56.57824-05
\.
...
344	2020-01-04 18:44:42.389936-05	3	 CANT_ORDENADA: 1	1	[{"added": {}}]	7	1
345	2020-01-04 18:52:22.616935-05	9	Tomato plus Basil	2	[{"changed": {"fields": ["topp_nombre"]}}]	9	1
346	2020-01-04 19:38:00.53835-05	5	2020-01-05 00:38:00.526721+00:00 activa ricardo	1	[{"added": {}}, {"added": {"name": "prod_orden", "object": " CANT_ORDENADA: 1 producto: Sub italian Subs small 4.95 datos dueno: 2020-01-05 00:38:00.526721+00:00 activa ricardo"}}]	8	1
\.
...
26	orders	0007_remove_prod_orden_topping	2020-01-04 19:06:38.417333-05
27	orders	0008_prod_orden_toppings	2020-01-04 19:06:38.456755-05
28	orders	0009_carritocompras	2020-01-04 19:24:53.08019-05
29	orders	0010_auto_20200105_0032	2020-01-04 19:34:24.980823-05
30	orders	0011_auto_20200105_0037	2020-01-04 19:37:32.568103-05
\.
...
46ky50ywwpdkjrdi0ybyo2stveqcy6fi	YWQ5M2Y4YTM3NjFhMWJiZmJiZTJjMjRiYzBhMjVlOTRlMTE1ZWFjMDp7Il9hdXRoX3VzZXJfaWQiOiIyIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiJkNjc3Yzg4YWU2MDcxY2I5ZGNiOWFjNWM3ZTg5YzlkZGU0ZDZjYjEwIn0=	2020-01-18 20:09:06.79626-05
\.


--
-- Data for Name: orders_carritocompras; Type: TABLE DATA; Schema: public; Owner: ricardo
--

COPY public.orders_carritocompras (id_prod_car, subtipo_prod_car, tamano_prod_car, precio_prod_car, toppings_prod_car, id_dueno_id, fecha_prod_car) FROM stdin;
\.
...
4	2019-11-16 19:00:00-05	calle 14	activa	1
5	2020-01-04 19:38:00.526721-05	calle false	activa	1
\.
...
COPY public.orders_prod_orden (id_prod_creado, cantidad, "id_ordenIn_id", "id_ptsWho_id", toppings) FROM stdin;
1	1	4	29	\N
3	1	4	97	\N
4	1	5	23	\N
\.
...
--
-- Name: orders_carritocompras_id_prod_car_seq; Type: SEQUENCE SET; Schema: public; Owner: ricardo
--

SELECT pg_catalog.setval('public.orders_carritocompras_id_prod_car_seq', 1, false);
...
SELECT pg_catalog.setval('public.orders_ordenes_id_orden_seq', 5, true);
...
SELECT pg_catalog.setval('public.orders_prod_orden_id_prod_creado_seq', 4, true);
...
--
-- Name: orders_carritocompras orders_carritocompras_pkey; Type: CONSTRAINT; Schema: public; Owner: ricardo
--

ALTER TABLE ONLY public.orders_carritocompras
    ADD CONSTRAINT orders_carritocompras_pkey PRIMARY KEY (id_prod_car);
...
--
-- Name: orders_carritocompras_id_dueno_id_52bdd1a0; Type: INDEX; Schema: public; Owner: ricardo
--

CREATE INDEX orders_carritocompras_id_dueno_id_52bdd1a0 ON public.orders_carritocompras USING btree (id_dueno_id);
...
--
-- Name: orders_carritocompras orders_carritocompras_id_dueno_id_52bdd1a0_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: ricardo
--

ALTER TABLE ONLY public.orders_carritocompras
    ADD CONSTRAINT orders_carritocompras_id_dueno_id_52bdd1a0_fk_auth_user_id FOREIGN KEY (id_dueno_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
